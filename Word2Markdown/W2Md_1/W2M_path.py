...
if __name__ == "__main__":
    file_path = '../data/DLT 1225-2013.抽水蓄能电站生产准备导则.docx'
    file_path2 = '../data/抽水蓄能可逆式发电电动机运行规程 16页.docx'
    file_path3 = '../data/抽水蓄能可逆式水泵水轮机运行规程 16页.docx'
    convert_docx_to_markdown(file_path)
    convert_docx_to_markdown(file_path2)
    convert_docx_to_markdown(file_path3)
